...
%         LOAD SPLINES INTO AXES IF DESIRED
        if showSplines
            ...
            if ~isempty(xSpline) && mean(xSpline)
                ...
                scatter(movieAx, xSpline, res(1) - ySpline + 1, 12, 'filled', 'MarkerFaceColor', 'w');
                scatter(movieAx, xC, res(1) - yC + 1, 30, 'filled', 'MarkerFaceColor', [1, 0.5, 0]);
            end
